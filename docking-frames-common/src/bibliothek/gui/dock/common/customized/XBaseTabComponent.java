...
@ColorCodes({
    ...
    "stack.border" })
public abstract class XBaseTabComponent extends ConfiguredBackgroundPanel implements XTabComponent, EclipseTabStateInfo{
	...
	private XButtonPanel buttons;
    private XEclipseDockActionSource actions;
    
    private boolean hasFocus;
    private boolean isSelected;
    private XEclipseTabPane pane;
    private XEclipseTab tab;
     ...
     */
    public XBaseTabComponent( XEclipseTabPane pane, Dockable dockable ){
     ...
     */    
    public XBaseTabComponent( XEclipseTabPane pane, Dockable dockable, String colorPostfix ){
...
//        colorStackTabBorderSelected = new BorderTabColor( "stack.tab.border.selected" + colorPostfix, station, Color.WHITE );
        colorStackTabBorderSelected = new BorderTabColor( "stack.tab.border.selected.focused" + colorPostfix, station, Color.WHITE );
...
//        colorStackTabTopSelected = new BaseTabColor( "stack.tab.top.selected" + colorPostfix, station, Color.LIGHT_GRAY );
        colorStackTabTopSelected = new BaseTabColor( "stack.tab.top.selected.focused" + colorPostfix, station, Color.LIGHT_GRAY );
...
//        colorStackTabBottomSelected = new BaseTabColor( "stack.tab.bottom.selected" + colorPostfix, station, Color.WHITE );
        colorStackTabBottomSelected = new BaseTabColor( "stack.tab.bottom.selected.focused" + colorPostfix, station, Color.WHITE );
...
//        colorStackTabTextSelected = new BaseTabColor( "stack.tab.text.selected" + colorPostfix, station, Color.BLACK );
        colorStackTabTextSelected = new BaseTabColor( "stack.tab.text.selected.focused" + colorPostfix, station, Color.BLACK );
		...
		buttons = new XButtonPanel(false);
        add( buttons );
    ...
    public void setTab( XEclipseTab tab ){
        if( background != null ){
    ...
    public void bind() {
        if( buttons != null ){
            actions = new XEclipseDockActionSource(
     ...
     * @return the owner
     */
    public XEclipseTabPane getPane(){
        return pane;
    }
    ...
    protected boolean isPreviousTabSelected(){
        ...
        XEclipseTab previous = pane.getVisibleTab( self-1 );
    ...
    protected boolean isNextTabSelected(){
        ...
        XEclipseTab next = pane.getVisibleTab( self+1 );
        if( next == null )
            return false;
     ...
     */
	public XButtonPanel getButtons() {
        return buttons;
    }
    ...
    public Dimension getMinimumSize( XTabComponent[] tabs ){
        setSelection( tabs );
    ...
    public Dimension getPreferredSize( XTabComponent[] tabs ){
        setSelection( tabs );
    ...
    private void setSelection( XTabComponent[] tabs ){
    ...
    private class BaseTabFont extends TabFont{
        public BaseTabFont( String id, DockStation station ){
            ...
            font(UIManager.getLookAndFeelDefaults().getFont("defaultFont"));
        }
        @Override
    ...
    private class Background extends BackgroundAlgorithm implements TabPaneTabBackgroundComponent{
         ...
         */
        public Background( XEclipseTab tab ){
        ...
        public Component getComponent(){
            return XBaseTabComponent.this.getComponent();
        }
    }
}
