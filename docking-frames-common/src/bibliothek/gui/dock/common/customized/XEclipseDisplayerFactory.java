 ...
 * @author Janni Kovacs
 */
public class XEclipseDisplayerFactory implements DisplayerFactory {
     ...
     */
    public XEclipseDisplayerFactory( XEclipseTheme theme ) {
        this.theme = theme;
    }
    ...
    protected DockableDisplayer create( DockStation station, Dockable dockable, DockTitle title ) {
        ...
        switch( bar ){
            ...
            case ECLIPSE:
                return new XEclipseDockableDisplayer( theme, station, dockable, title );
            case BASIC_BORDERED:
