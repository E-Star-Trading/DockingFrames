 ...
 */
public class XEclipseTab extends XAbstractTab implements CombinedTab{
    /** painting code for this tab */
    private XTabComponent component;
    
    private XEclipseTabPane parent;
     ...
     */
    public XEclipseTab( XEclipseTabPane parent, Dockable dockable, XTabComponent delegate ){
     ...
     */
    public XTabComponent getTabComponent(){
        return component;
    }
    ...
    private XTabComponent[] extract( Tab[] tabs ){
        XTabComponent[] components = new XTabComponent[ tabs.length ];
        for( int i = 0; i < tabs.length; i++ ){
            if( tabs[i] instanceof XEclipseTab ){
                components[i] = ((XEclipseTab)tabs[i]).getTabComponent();
            }
        }
        return components;
    }
    ...
    public Insets getOverlap( TabPaneComponent other ){
        if( other instanceof XEclipseTab ){
            XEclipseTab tab = (XEclipseTab)other;
