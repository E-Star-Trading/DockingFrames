...
public class XEclipseTabInfo extends DockActionCombinedInfoComponent {
    private XEclipseTabPane pane;
    private XEclipseDockActionSource currentActions;
    
    /**
     * Creates a new component.
     * @param pane the owner of this info
     */
    public XEclipseTabInfo( XEclipseTabPane pane ){
        super( pane );
        this.pane = pane;
    }
    ...
    protected DockActionSource createActionSource( Dockable dockable ){
        XEclipseTab tab = pane.getOnTab( dockable );
        currentActions = new XEclipseDockActionSource( pane.getTheme(), dockable.getGlobalActionOffers(), tab.getEclipseTabStateInfo(), false );
