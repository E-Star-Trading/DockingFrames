...
public class XCEclipseTheme extends CDockTheme<XEclipseTheme>{
     ...
     */
    public XCEclipseTheme( CControl control, XEclipseTheme theme ){
        super( theme );
        init( control );
    }
     ...
     * @param control the controller for which this theme will be used.
     */
    public XCEclipseTheme( CControl control ){
        this( new XEclipseTheme() );
        init( control );
    }
     ...
     */
    private XCEclipseTheme( XEclipseTheme theme ){
    ...
    public void install( DockController controller ) {
        ...
        Map<String, Icon> icons = DockUtilities.loadIcons(
                "data/bibliothek/gui/dock/common/icons/eclipse/icons.ini", null, XCEclipseTheme.class.getClassLoader() );
