...
public class XEclipseTheme extends BasicTheme {
     ...
     */
    public static final PropertyKey<XTabPainter> TAB_PAINTER = new PropertyKey<XTabPainter>( "EclipseTheme tab painter", new ConstantPropertyFactory<XTabPainter>( XEclipseTabPainter.FACTORY ), true );
     ...
     */
	public static final PropertyKey<EclipseThemeConnector>	THEME_CONNECTOR				= new PropertyKey<>("EclipseTheme theme connector", new ConstantPropertyFactory<>(new XDefaultEclipseThemeConnector()), true);
    ...
    public XEclipseTheme(){
        ...
        setStackDockComponentFactory( new StackDockComponentFactory(){
            public StackDockComponent create( StackDockComponentParent station ){
                return new XEclipseTabPane( XEclipseTheme.this, station.getStackDockParent() );
            }
        }, Priority.DEFAULT );
        setDisplayerFactory( new XEclipseDisplayerFactory( this ), Priority.DEFAULT );
		...
		setSpanFactory(new XSpanFactory());
    }

    @Override
    public void install( DockController controller ){
        DockTitleManager titleManager = controller.getDockTitleManager();
        titleManager.registerTheme( XEclipseTheme.TAB_DOCK_TITLE, BasicTabDockTitle.FACTORY );

        super.install( controller );

        controller.getIcons().setScheme( Priority.THEME, new DefaultIconScheme( "data/bibliothek/gui/dock/core/eclipse/icons.ini", XEclipseTheme.class.getClassLoader(), controller ) );

        XEclipseDockTitleFactory factory = new XEclipseDockTitleFactory( this, new ControllerTitleFactory() );
