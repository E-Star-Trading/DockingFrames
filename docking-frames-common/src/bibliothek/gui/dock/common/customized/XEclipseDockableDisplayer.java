 ...
 */
public class XEclipseDockableDisplayer extends BasicDockableDisplayer{
     ...
     */
    public XEclipseDockableDisplayer( XEclipseTheme theme, DockStation station, Dockable dockable, DockTitle title ){
        super( station, false );
        ...
        observer = new TitleBarObserver( station, dockable, TitleBar.ECLIPSE ){
            ...
            protected void invalidated(){
                for( DockableDisplayerListener listener : listeners() ){
                    listener.discard( XEclipseDockableDisplayer.this );
                }
            }
        };
