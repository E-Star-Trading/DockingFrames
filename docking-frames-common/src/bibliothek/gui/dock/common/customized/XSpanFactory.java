 ...
 * Swing-Component the developer likes to add. Copyright (C) 2012 Benjamin Sigg This library is free software; you can
 * redistribute it and/or modify it under the terms of the GNU Lesser General Public License as published by the Free
 * Software Foundation; either version 2.1 of the License, or (at your option) any later version. This library is
 ...
 * Free Software Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301 USA Benjamin Sigg
 * benjamin_sigg@gmx.ch CH - Switzerland
 */
...
/**
 * This factory creates {@link Span}s that always have a fix size.
 * 
 * @author Benjamin Sigg
 */
public class XSpanFactory implements SpanFactory {
